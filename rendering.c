...
int* renderTest(int *renderArr, int camX, int camY, int camT, int camD) { //returns an array of k_nPixels colors
    double k0 = -cos(pi/180*(90-k_FOV/2.0-camT));
    double k1 = camD/cos(pi/180*k_FOV/2.0)*cos(pi/180*camT);
    double k2 = sin(pi/180*(90-k_FOV/2.0-camT));
    double k3 = camD/cos(pi/180*k_FOV/2.0)*sin(pi/180*camT);
...
int main(int argc, char **argv) {
    ...
    int *renderptr = renderTest(rendered, 0,0,-30,10);
