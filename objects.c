...
void ob_init() {
    ...
    ob_brick = salloc(sizeof(line) * k_nMaxLinesPerObj);
    i = 0;
    //top face
    ...
    i=0;
    ob_coin = salloc(sizeof(line) * k_nMaxLinesPerObj);
    ob_coin[i++] = (line) { .x1=5, .y1=0, .x2=2, .y2=0, .r=179, .g=114, .b=50 };

    ob_coin[i++] = (line) { .x1=2, .y1=0, .x2=0, .y2=3, .r=191, .g=122, .b=54 };

    ob_coin[i++] = (line) { .x1=0, .y1=3, .x2=0, .y2=10, .r=217, .g=139, .b=61 };

    ob_coin[i++] = (line) { .x1=0, .y1=10, .x2=2, .y2=13, .r=255, .g=163, .b=71 };

    ob_coin[i++] = (line) { .x1=2, .y1=13, .x2=5, .y2=13, .r=255, .g=178, .b=86 };

    ob_coin[i++] = (line) { .x1=5, .y1=13, .x2=7, .y2=13, .r=77, .g=49, .b=21 };
    ob_coin[i++] = (line) { .x1=7, .y1=13, .x2=9, .y2=10, .r=77, .g=49, .b=21 };
    ob_coin[i++] = (line) { .x1=9, .y1=10, .x2=9, .y2=3, .r=77, .g=49, .b=21 };
    ob_coin[i++] = (line) { .x1=9, .y1=3, .x2=7, .y2=0, .r=77, .g=49, .b=21 };
    ob_coin[i++] = (line) { .x1=7, .y1=0, .x2=5, .y2=0, .r=77, .g=49, .b=21 };

    ob_nothing = salloc(sizeof(line));
    i=0;
    ob_nothing[i++] = (line) { .x1=0, .y1=0, .x2=0, .y2=0, .r=0, .g=0, .b=0 };

    ob_playerBox = salloc(sizeof(line)*5);
    i=0;
    ob_playerBox[i++] = (line) { .x1=-14, .y1=2, .x2=2, .y2=2, .r=200, .g=200, .b=200 };
    ob_playerBox[i++] = (line) { .x1=2, .y1=2, .x2=2, .y2=-14, .r=200, .g=200, .b=200 };
    ob_playerBox[i++] = (line) { .x1=2, .y1=-14, .x2=-14, .y2=-14, .r=200, .g=200, .b=200 };
    ob_playerBox[i++] = (line) { .x1=-14, .y1=-14, .x2=-14, .y2=2, .r=200, .g=200, .b=200 };
    ob_playerBox[i++] = (line) { .x1=0, .y1=0, .x2=0, .y2=0, .r=0, .g=0, .b=0 };
